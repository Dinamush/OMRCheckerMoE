...
- **`MoE-April-2026-Landscape-NNQ25-0/template.json`** had its answer-block origins offset **+5px in y** from the actual printed bubble centres on `prefill_package/blank_template_reference.png`.
