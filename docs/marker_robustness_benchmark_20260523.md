...
```powershell
python scripts/bench_marker_robustness.py --rows 10 --profile full --label robustness-full-20260523 --out robustness_full_20260523.json
```

Updated confidence-gated command:

```powershell
python scripts/bench_marker_robustness.py --rows 10 --profile full --label robustness-confidence-full-20260523 --out robustness_confidence_full_20260523.json
```
