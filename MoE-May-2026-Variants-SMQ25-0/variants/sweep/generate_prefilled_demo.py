...
The output is written to:
  MoE-May-2026-Variants-SMQ25-0/reference/prefilled_MoE-May-2026-Variants-SMQ25-0_demo.png
"""
...
from generate_sheet import SheetSpec, render_blank
...
OUTPUT_PATH = (
    Path(__file__).resolve().parents[2] / "reference" / "prefilled_MoE-May-2026-Variants-SMQ25-0_demo.png"
)
