...
def main() -> None:
    ...
    paths = [
        repo_root / "MoE-May-2026-Variants-SMQ25-0" / "reference" / "blank_MoE-May-2026-Variants-SMQ25-0.png",
        repo_root / "MoE-May-2026-Variants-SMQ25-0" / "variants" / "variant_a_portrait.png",
    ]
    sweep_runs = repo_root / "MoE-May-2026-Variants-SMQ25-0" / "variants" / "sweep" / "runs"
