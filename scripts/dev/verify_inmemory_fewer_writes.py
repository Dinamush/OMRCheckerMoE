...
Usage::
    ...
    python scripts/dev/verify_inmemory_fewer_writes.py --pages 20
...
def _run(pages: int, *, inmemory: bool) -> dict:
    ...
    source = REPO_ROOT / "MoE-April-2026-Landscape-NNQ25-0" / "inputs" / \
    ...
    shutil.copy2(
        REPO_ROOT / "MoE-April-2026-Landscape-NNQ25-0" / "template.json",
