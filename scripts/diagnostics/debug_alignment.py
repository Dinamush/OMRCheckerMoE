...
Run from repo root: ``python scripts/diagnostics/debug_alignment.py``
"""
...
TEMPLATE_PNG = REPO_ROOT / "prefill_package" / "blank_template_reference.png"
...
def run_omr(png_path: Path) -> dict:
    ...
    template_json = REPO_ROOT / "MoE-April-2026-Landscape-NNQ25-0" / "template.json"
    config_payload = {
        "dimensions": {
