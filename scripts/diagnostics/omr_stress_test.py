...
Pre-reqs: MoE-April-2026-Landscape-NNQ25-0/ present, .venv active.
"""
...
PREFILL_SCRIPT = REPO_ROOT / "prefill_package" / "prefill_answer_sheet_final.py"
...
def run_omr_direct(label: str, expectation: str, image_bytes: bytes, ext: str) -> RunResult:
    ...
    Layout under omr_stress_artifacts/<label>/:
        ...
        template.json   — copied from MoE-April-2026-Landscape-NNQ25-0
